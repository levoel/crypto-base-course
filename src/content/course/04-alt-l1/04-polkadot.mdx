...
import { PolkadotNetworkDiagram, HybridConsensusDiagram, NPoSElectionDiagram, SlotAuctionDiagram, XCMPFlowDiagram, SubstrateFrameworkDiagram, ParachainExamplesDiagram } from '../../../components/diagrams/AltL1Diagrams';
...
<PolkadotNetworkDiagram client:load />
...
Parachains — application-specific blockchains с custom state transition logic, optional token economics, shared security от Relay Chain, и slot lease через auction или parathreads.

<ParachainExamplesDiagram client:load />
...
<HybridConsensusDiagram client:load />
...
<NPoSElectionDiagram client:load />
...
<SlotAuctionDiagram client:load />
...
<SubstrateFrameworkDiagram client:load />

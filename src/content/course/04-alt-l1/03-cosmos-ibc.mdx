...
import { CosmosVsEthereumDiagram, CosmosSDKArchitectureDiagram, IBCProtocolDiagram, IBCTransferDiagram, TendermintRoundDiagram, InterchainSecurityDiagram, ABCIDiagram } from '../../../components/diagrams/AltL1Diagrams';
...
<CosmosVsEthereumDiagram client:load />
...
<CosmosSDKArchitectureDiagram client:load />

### ABCI (Application Blockchain Interface)

<ABCIDiagram client:load />

ABCI позволяет писать app logic на любом языке (Go, Rust via CosmWasm, etc.)
...
<TendermintRoundDiagram client:load />
...
<IBCProtocolDiagram client:load />

### IBC Token Transfer

<IBCTransferDiagram client:load />
...
<InterchainSecurityDiagram client:load />

...
import { PoSVariantsDiagram, ValidatorConcentrationDiagram, FinalityComparisonDiagram, ExecutionModelsDiagram } from '../../../components/diagrams/AltL1Diagrams';
...
<PoSVariantsDiagram client:load />
...
<FinalityComparisonDiagram client:load />
...
<ExecutionModelsDiagram client:load />
...
<ValidatorConcentrationDiagram client:load />

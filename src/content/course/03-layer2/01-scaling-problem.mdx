...
import { BlockchainTrilemmaDiagram, RollupArchitectureDiagram, VerticalScalingDiagram, ShardingDiagram, L2SolutionsDiagram } from '../../../components/diagrams/Layer2Diagrams';

...
import { BlockchainTrilemmaDiagram, RollupArchitectureDiagram, VerticalScalingDiagram, ShardingDiagram, L2SolutionsDiagram, StateChannelDiagram, PlasmaDiagram } from '../../../components/diagrams/Layer2Diagrams';
...
<VerticalScalingDiagram client:load />
...
<L2SolutionsDiagram client:load />
...
<StateChannelDiagram client:load />

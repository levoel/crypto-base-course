...
import { DataWithholdingDiagram, DankshardingDiagram, CelestiaDiagram, EigenDADiagram } from '../../../components/diagrams/Layer2Diagrams';
...
<DataWithholdingDiagram client:load />
...
<DankshardingDiagram client:load />

...
import { OptimisticVsZKDiagram, InteractiveBisectionDiagram, WithdrawalFlowDiagram, OptimisticRollupArchDiagram, ArbitrumArchitectureDiagram, OPStackDiagram } from '../../../components/diagrams/Layer2Diagrams';
...
<OptimisticRollupArchDiagram client:load />
...
<InteractiveBisectionDiagram client:load />
...
<ArbitrumArchitectureDiagram client:load />
...
<WithdrawalFlowDiagram client:load />

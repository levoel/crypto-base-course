...
import { ZkEVMSpectrumDiagram, ZkRollupArchDiagram, ProverPipelineDiagram, ProofAggregationDiagram, ZKProofFlowDiagram } from '../../../components/diagrams/Layer2Diagrams';
...
<ZKProofFlowDiagram client:load />
...
<ZkRollupArchDiagram client:load />
...
<ZkEVMSpectrumDiagram client:load />
...
<ProverPipelineDiagram client:load />

### Proof Aggregation

<ProofAggregationDiagram client:load />
